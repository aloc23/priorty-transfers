    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md relative animate-fade-in">
        ...
        <h2 className="text-xl font-bold mb-6 text-red-700 flex items-center gap-2">
          <CheckIcon className="w-6 h-6 drop-shadow-sm hover:drop-shadow-lg" /> Add Expense
        </h2>
        <form
          className="space-y-4"
          onSubmit={e => {
        ...
        >
          <div>
            ...
            <input
              type="date"
              className="form-input w-full rounded-lg border-red-300 focus:border-red-500 focus:ring-red-500"
              value={form.date}
          ...
          <div className="flex gap-2 pt-4 justify-end">
            <button type="submit" className="btn btn-danger shadow-md hover:shadow-lg">
              Save
            </button>
